    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-20 grid h-full w-full grid-cols-1 lg:grid-cols-[62%_1fr] pointer-events-none">
        <div className="flex flex-col justify-start pt-12 px-6 sm:justify-center sm:pt-0 sm:px-12 pointer-events-auto">
          <div className="max-w-[65%] sm:max-w-2xl pr-0 sm:pr-12 lg:pr-28">
            <h2 className="mb-4 font-geom text-3xl font-medium leading-tight text-white drop-shadow-sm sm:text-4xl md:text-5xl lg:text-5xl">
              Transformamos iniciativas de reciclagem em projetos aptos a captar recursos via Lei de Incentivo a Reciclagem
            </h2>

            <p className="mb-8 sm:mb-12 font-object-sans text-lg sm:text-xl font-light italic leading-relaxed tracking-wide text-gray-200 uppercase">
            ...
            <div className="flex flex-col items-start gap-4 sm:flex-row">
              <a
                ...
                className="group flex items-center gap-2 rounded-tl-3xl rounded-br-3xl bg-mata-100 px-6 py-2 sm:px-8 sm:py-3 text-base sm:text-lg font-bold text-mata-950 shadow-lg transition-all duration-300 ease-in-out hover:scale-105 hover:bg-white active:scale-95"
              >
                <span>SAIBA +</span>
              </a>
            </div>
