...
const Card = ({ url, category, title, description }: ItemType) => {
  return (
    ...
    >
      <div className="absolute inset-0 z-20 rounded-2xl bg-linear-to-b from-black/90 via-black/60 to-black/0 p-6 text-white transition-[backdrop-filter] hover:backdrop-blur-sm">
