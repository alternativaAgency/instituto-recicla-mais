...
const MapOnly = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-80px)] bg-mata-950 flex items-center justify-center p-4">
      <div className="w-full h-full max-w-6xl max-h-[800px] relative overflow-hidden rounded-xl border border-mata-800 shadow-2xl">
        <Map
          ref={mapRef}
          {...viewState}
          onMove={(evt) => setViewState(evt.viewState)}
          {...settings}
          mapStyle="/maps/brazil-focus.json"
          style={{
            width: "100%",
            height: "100%",
            position: "relative",
            ...
            <Layer
              ...
              paint={{
                "fill-color": [
                  ...
                  "#113623" // ocean color for other countries (matches map water)
                ],
                "fill-opacity": 1
              }}
            />
            <Layer
              ...
              paint={{
                "line-color": [
                  ...
                  "#ede7e7", // limpeza color for Brazil
                  "rgba(0, 0, 0, 0)" // transparent for other countries
                ],
                "line-width": 1.5,
                "line-opacity": 0.7
              }}
